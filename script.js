// Loot item list
const lootItems = [
  { title: "Mug of Stale Coffee", description: "All coffee poured on it becomes stale." },
  ...
  { title: "Visibility Cape", description: "A Cape that turns visible when wore." },
  ...
  { title: "Ring of Hairy fingers", description: "Allows the wearer to grow their finger hairs once a day." },
  { title: "Crown of immortality", description: "An almost impossible crown to kill" },
  { title: "Hat of Hat Seduction", description: "Allows the wearer to seduce hats." },
  { title: "Ring of Desaturation", description: "All colour of the wearer is desaturated." },
  ...
  { title: "Longest word Papyrus", description: "A Papyrus that records the longest word the wearer said during the day. Resets at midnight." },
  { title: "Tablespoon of Salt", description: "A table that can support exactly a spoon of salt."},
  { title: "Ring of Wishes", description: "Allows the wearer to wish for anything." },
  { title: "Arrow of Fly slaying", description: "Deals extra damage to flies. " },
  ...
  { title: "Sleeve pouch of Aces", description: "A little pouch attacheable to your sleeve. it has a 4/52th chance of drawing an Ace." },
  ...
  { title: "Hood of Mistery", description: "A hood that makes you look very misterous."},
  ...
  { title: "Coin of Heads", description: "A coin that always lands on someone's head."},
  { title: "Coin of Tails", description: "A coin that always lands on someone's tail."},
  { title: "Tote bag of Item Holding", description: "A tote bad that hides any item in a cluster of random items."},
  ...
  { title: "Lava Lamp", description: "A lamp that can turns into lava when lit."},
